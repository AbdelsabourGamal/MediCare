...
# @csrf_exempt
# @login_required(login_url="login")
# def paypal_payment_request_pharmacy(request, pk, id, pk2):
#     if request.user.is_patient:
#         patient = Patient.objects.get(patient_id=pk)
#         test_order = testOrder.objects.get(id=id)
#          = Prescription_test.objects.get(test_id=pk2)
...
#     }
#     return render(request, 'payment_pharmacy.html', context)

# @csrf_exempt
# def pharmacy_payment_complete(request):
#     data = json.loads(request.body)
